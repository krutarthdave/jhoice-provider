...
import 'package:home_services_provider/app/modules/notifications/widgets/notification_item_widget.dart';
...
class SnackDismissDirection {
  static var HORIZONTAL;
}

class Icons {
  static var check_circle_outline;

  static var remove_circle_outline;

  static var warning_amber_rounded;

  static var notifications_none;

  static var star_half;

  static var star;

  static var star_border;

  static var notifications_outlined;

  static var delete_outline;
}

class Icon {
  Icon(check_circle_outline, {int size, color});
}
