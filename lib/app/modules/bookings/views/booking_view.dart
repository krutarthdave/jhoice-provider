...
class BookingView extends GetView<BookingController> {
  ...
  Widget build(BuildContext context) {
    int duration = 0;
    int timeRemaining = 0;
    print(controller.booking.value.mode);
    print(controller.booking.value.location);
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
          onRefresh: () async {
            Get.find.forceRefresh();
            controller.refreshBooking(showMessage: true);
            Get.find.unForceRefresh();
          },
              ...
              SliverToBoxAdapter(
                child: Column(
                  ...
                  children: [
                    ...
                    controller.booking.value.mode.isNotEmpty
                        ? BookingTilWidget(
                        ...
                        : Container(),
                    controller.booking.value.location.isNotEmpty
                        ? BookingTilWidget(
                            ...
                            content: Text(
                                controller.booking.value.location == 'both'
                                    ...
                                    : controller.booking.value.location ==
                                            'office'
                            ...
                            content: Column(
                              children: [
                                BookingRowWidget(
                                    ...
                                    hasDivider: false),
                                Text("Your Booking shall be auto cancelled if provider does not accept this booking in the above-mentioned time",
                                        style: Get.textTheme.caption)
                                    .paddingOnly(top: 10),
                              ],
                            ))
