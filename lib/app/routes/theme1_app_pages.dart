...
import 'package:home_services_provider/app/modules/addresses/bindings/address_binding.dart';
import 'package:home_services_provider/app/modules/addresses/views/address_picker_view.dart';
import 'package:home_services_provider/app/modules/addresses/views/addresses_view.dart';
import 'package:home_services_provider/app/modules/coupons/bindings/coupon_bindings.dart';
import 'package:home_services_provider/app/modules/coupons/views/coupons_form_view.dart';
import 'package:home_services_provider/app/modules/coupons/views/coupons_view.dart';
import 'package:home_services_provider/app/modules/e_providers/bindings/e_provider_binding.dart';
import 'package:home_services_provider/app/modules/e_providers/views/e_provider_form_view.dart';
import 'package:home_services_provider/app/modules/e_providers/views/e_providers_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(name: Routes.ADDRESSES, page: () => AddressesView(), binding: AddressesBinding(), transition: Transition.downToUp),
    GetPage(name: Routes.COUPONS, page: () => CouponsView(), binding: CouponsBinding(), transition: Transition.downToUp),
    GetPage(name: Routes.COUPON_FORM, page: () => CustomCouponFormView(), binding: CouponsBinding()),
    GetPage(name: Routes.E_PROVIDERS, page: () => EProvidersView(), binding: EProvidersBinding(), transition: Transition.downToUp),
    GetPage(name: Routes.E_PROVIDER_FORM, page: () => EProviderFormView(), binding: EProvidersBinding()),
    GetPage(name: Routes.ADDRESS_PICKER, page: () => AddressPickerView()),
