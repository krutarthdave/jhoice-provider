...
class EServiceView extends GetView<EServiceController> {
                        ...
                        EServiceTilWidget(
                          ...
                          content: Text(
                              _eService.location == 'both'
                                  ? "You can visit customer's home, as well as Customer can come to your office"
                                  : _eService.location == 'office'
                                      ? "Customer will come to your office"
                                      : _eService.location == 'home'
                                          ? "Your will travel to Customer's home"
                                          : "Not Mentioned",
                              style: Get.textTheme.bodyText1),
                        ),
  ...
  Container buildDuration(EService _eService) {
    return _eService.duration.isNotEmpty
        ? Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                    _eService.duration +
                        "${_eService.getFixedUnit ?? _eService.getUnit}",
